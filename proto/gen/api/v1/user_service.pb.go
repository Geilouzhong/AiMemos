...
const file_api_v1_user_service_proto_rawDesc = "" +
	...
	"\x18enable_activity_tracking\x18\r \x01(\bB\x03\xe0A\x01R\x16enableActivityTracking\";\n" +
	"\x04Role\x12\x14\n" +
	...
	"\x16DeleteUserNotification\x12+.memos.api.v1.DeleteUserNotificationRequest\x1a\x16.google.protobuf.Empty\"5\xdaA\x04name\x82\xd3\xe4\x93\x02(*&/api/v1/{name=users/*/notifications/*}B\xad\x01\n" +
	"\x10com.memos.api.v1B\x10UserServiceProtoP\x01Z5github.com/Geilouzhong/AiMemos/proto/gen/api/v1;apiv1\xa2\x02\x03MAX\xaa\x02\fMemos.Api.V1\xca\x02\fMemos\\Api\\V1\xe2\x02\x18Memos\\Api\\V1\\GPBMetadata\xea\x02\x0eMemos::Api::V1b\x06proto3"
