...
export const file_api_v1_auth_service: GenFile = /*@__PURE__*/
  fileDesc("", [file_api_v1_user_service, file_google_api_annotations, file_google_api_field_behavior, file_google_protobuf_empty, file_google_protobuf_timestamp]);
...
export type SignInRequest = Message<"memos.api.v1.SignInRequest"> & {
  ...
  credentials: {
     ...
     *
     * @generated from field: memos.api.v1.SignInRequest.GuestCredentials guest_credentials = 3;
     */
    value: SignInRequest_GuestCredentials;
 ...
 *
 * @generated from message memos.api.v1.SignInRequest.GuestCredentials
 */
export type SignInRequest_GuestCredentials = Message<"memos.api.v1.SignInRequest.GuestCredentials"> & {
  /**
   * The guest code.
   *
...
/**
 * Describes the message memos.api.v1.SignInRequest.GuestCredentials.
 * Use `create(SignInRequest_GuestCredentialsSchema)` to create a new message.
 */
export const SignInRequest_GuestCredentialsSchema: GenMessage<SignInRequest_GuestCredentials> = /*@__PURE__*/
