...
export type User = Message<"memos.api.v1.User"> & {
   ...
   *
   * @generated from field: bool is_guest = 12;
   */
  isGuest: boolean;
   ...
   *
   * @generated from field: bool enable_activity_tracking = 13;
   */
